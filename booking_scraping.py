        ...
        if start_date_str in displayed_dates and end_date_str in displayed_dates:
            ...
            for block in accommodation_blocks:
                ...
                try:
                    ...
                    price = float(price_string.replace("€", "").replace(",", "").strip())
                except:
            ...
            name_general_results = os.path.join(general_results_path, f'results_{start_date_str}&{end_date_str}_{place}.csv')
            ...
            # Define the file name with the complete path
            name_url_data = os.path.join(url_data_path, f'urls_{start_date_str}&{end_date_str}_{place}.csv')
...
# Once all of the results are obtained, close the browser
browser.quit()

print('Finished general data extraction successfully. Browser closed. Continuing with description scraping.')
